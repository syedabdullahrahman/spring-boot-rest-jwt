...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@ApiParam("Signin User") @Valid @RequestBody LoginRequest loginRequest) {
  ...
  public ResponseEntity<?> registerUser(@ApiParam("Signup User") @Valid @RequestBody SignupRequest signUpRequest) {
